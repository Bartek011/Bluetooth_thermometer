...
public class Thermometer extends View {
    ...
    private static final int GRADUATION_TEXT_SIZE = 20;     // in sp
    private static float DEGREE_WIDTH = 30;
    private static final int NB_GRADUATIONS = 4;
    public static final float MAX_TEMP = 30;
    public static final float MIN_TEMP = 10;
    public static final float RANGE_TEMP = 20;
    private static final int NB_GRADUATIONS_F = 8;
    private static final float MAX_TEMP_F = 120;
    private static final float MIN_TEMP_F = -30;
    public static final float RANGE_TEMP_F = 150;
    ...
    public void init(Context context, AttributeSet attrs){
        ...
        degreePaint.setStrokeWidth(middleCircleRadius / 20);
